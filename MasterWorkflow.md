...
Nine self-contained master prompts. Each is written to be pasted verbatim into a smaller model's
...
These 9 prompts are implemented as Claude Code skills (see the `skills/` directory in this repo).
